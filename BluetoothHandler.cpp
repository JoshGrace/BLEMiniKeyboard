...
#pragma region bluetooth_key_configurations
/* 
format modifier-00-code-code-code-code-code-code
AT+BLEKEYBOARDCODE=0A-00-14-00-00-00-00
shift-command-Q
...
void BluetoothHandler::sendKeyStrokes(char **keyCode) {
	while(*keyCode){
		int position = 0;
	...
	// ble.println("AT+BLEKEYBOARDCODE=0A-00-14-00-00-00-00");
	// ble.waitForOK();
